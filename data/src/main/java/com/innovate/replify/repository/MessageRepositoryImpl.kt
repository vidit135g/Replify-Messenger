...
import com.innovate.replify.common.util.extensions.now
import com.innovate.replify.compat.TelephonyCompat
import com.innovate.replify.extensions.anyOf
...
import com.innovate.replify.receiver.SmsDeliveredReceiver
import com.innovate.replify.receiver.SmsSentReceiver
import com.innovate.replify.util.ImageUtils
...
class MessageRepositoryImpl @Inject constructor(
    ...
    override fun savePart(id: Long): File? {
        ...
        val dir = File(Environment.getExternalStorageDirectory(), "replify/Media").apply { mkdirs() }
