...
class Navigator @Inject constructor(
    ...
    /**
     * @param source String to indicate where this replify+ screen was launched from. This should be
     * one of [main_menu, compose_schedule, settings_night, settings_theme]
     */
    fun showQksmsPlusActivity(source: String) {
        analyticsManager.track("Viewed replify+", Pair("source", source))
    ...
    fun showRating() {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.innovate.replify"))
        ...
        try {
            ...
            val url = "http://innovate.google.com/store/apps/details?id=com.innovate.replify"
    ...
    fun showSupport() {
        ...
        intent.putExtra(Intent.EXTRA_EMAIL, arrayOf("jai135g@gmail.com"))
        intent.putExtra(Intent.EXTRA_SUBJECT, "replify Support")
