...
import com.innovate.replify.databinding.MainActivityBinding
import com.innovate.replify.feature.blocking.BlockingDialog
import com.innovate.replify.feature.changelog.ChangelogDialog
import com.innovate.replify.feature.conversations.ConversationItemTouchCallback
import com.innovate.replify.feature.conversations.ConversationsAdapter
...
class MainActivity : QkThemedActivity(), MainView {
    ...
    private val toggle by lazy { ActionBarDrawerToggle(this, binding.drawerLayout, binding.bottomAppBar, R.string.main_drawer_open_cd, 0) }
    ...
    private val lottie by lazy {findViewById<LottieAnimationView>(R.id.empty_list)}
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val redPart = "Replify "
        val bluePart = "Central"

        val builder = SpannableStringBuilder()

        val redColoredString = SpannableString(redPart)
        val color=ContextCompat.getColor(this, R.color.gblue)
        val fcs = ForegroundColorSpan(color)
        redColoredString.setSpan(fcs, 0, redPart.length, 0)
        builder.append(redColoredString)
        val color2=ContextCompat.getColor(this, R.color.ggray)
        val fcs2 = ForegroundColorSpan(color2)
        val blueColoredString = SpannableString(bluePart)
        blueColoredString.setSpan(fcs2, 0, bluePart.length, 0)
        builder.append(blueColoredString)
        binding.toolbarSearch.setHint(builder)

        val bottomBar = findViewById<BottomAppBar>(R.id.bottom_app_bar)
        bottomBar.replaceMenu(R.menu.search)
        ...
        val ed:EditText=findViewById(R.id.toolbarSearch)
       ...
       // binding.toolbarTitle.setVisible(binding.toolbarSearch.visibility != View.VISIBLE)
        ...
        when (state.page) {
            ...
            is Searching -> {
                ...
                if(searchAdapter.itemCount==0) lottie.visibility=View.VISIBLE
