...
import com.innovate.replify.databinding.GalleryImagePageBinding
import com.innovate.replify.databinding.GalleryInvalidPageBinding
import com.innovate.replify.databinding.GalleryVideoPageBinding
    ...
    override fun onBindViewHolder(holder: QkViewHolder<ViewBinding>, position: Int) {
        ...
        when {
            ...
            getItemViewType(position) == VIEW_TYPE_VIDEO && holder.binding is GalleryVideoPageBinding -> {
                ...
                val dataSourceFactory = DefaultDataSourceFactory(context, Util.getUserAgent(context, "replify"))
